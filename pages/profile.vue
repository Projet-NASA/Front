        ...
        <div class="flex flex-col mb-8">
          ...
          <div class="mx-6">
            <div class="flex flex-row justify-between">
              ...
              <Icon name="material-symbols:edit" class="w-10 h-10 mt-4 p-2 text-primary-default hover:bg-primary-400 hover:text-white rounded-full cursor-pointer transition-colors duration-300" />
            </div>
