    ...
    <div v-else class="w-full sm:w-3/4 md:w-3/4 lg:w-3/4 xl:w-3/4">
      <div class="my-8 bg-secondary-200 shadow-md rounded pb-8">
        <div class="flex flex-col mb-8">
          <div class="flex flex-row-reverse">
            <div
              class="w-full h-40 bg-secondary-300 animate-pulse rounded"
            ></div>
          </div>
          <div class="mx-6">
            <div class="flex flex-row justify-between">
              <div
                class="w-32 h-32 bg-secondary-300 animate-pulse rounded-full -mt-20"
              ></div>
              <div
            ...
            <div class="mb-8">
              ...
              <div class="mx-6 mt-4 border-t border-secondary-300 pt-4">
                <div class="flex flex-col justify-between">
                  ...
                  <div
                    class="h-6 bg-secondary-300 animate-pulse w-1/4 mt-1"
                  ></div>
                  <div
                    class="h-6 bg-secondary-300 animate-pulse w-1/4 mt-1"
                  ></div>
                ...
                <div
                  class="h-6 bg-secondary-300 animate-pulse w-3/4 mt-1"
                ></div>
              </div>
            </div>
            <div class="mb-8">
      ...
      >
        <svg
          class="w-20 h-20 mx-auto my-auto text-primary-default animate-spin"
